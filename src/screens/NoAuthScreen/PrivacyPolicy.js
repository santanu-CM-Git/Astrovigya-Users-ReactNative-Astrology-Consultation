...
export default function PrivacyPolicy() {
  ...
  `)
  const tagsStyles = {
    h1: { color: '#2D2D2D',fontSize: responsiveFontSize(3),fontFamily:'PlusJakartaSans-SemiBold' },
    h2: { color: '#444343',fontSize: responsiveFontSize(2),fontFamily:'PlusJakartaSans-Regular'  }, // Example of adding more styles
