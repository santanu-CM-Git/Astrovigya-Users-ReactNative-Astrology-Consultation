        ...
        <SafeAreaView style={styles.Container}>
            ...
            <ScrollView style={styles.wrapper}>
                <View style={{justifyContent:'center',alignItems:'center',marginTop: responsiveHeight(15)}}>
                    ...
                    <Text style={{color:'#3A3232',fontFamily:'PlusJakartaSans-Medium',fontSize: responsiveFontSize(2),marginVertical: responsiveHeight(2)}}>No Notification Yet</Text>
                    <Text style={{color:'#949494',fontFamily:'PlusJakartaSans-Medium',fontSize: responsiveFontSize(2),textAlign:'center'}}>No Notification right now. notifications about your activity will show up here</Text>
                </View>
            </ScrollView>
        </SafeAreaView>
    )
