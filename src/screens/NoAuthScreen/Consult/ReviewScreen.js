        ...
        <SafeAreaView style={styles.Container}>
            ...
            <ScrollView style={styles.wrapper}>
                <View style={{ marginBottom: responsiveHeight(5), alignSelf: 'center', marginTop: responsiveHeight(2) }}>
                    ...
                    <Text style={{ fontSize: responsiveFontSize(2), color: '#746868', fontFamily: 'PlusJakartaSans-Regular', textAlign: 'center', marginTop: responsiveHeight(2), marginBottom: responsiveHeight(5) }}>How was your experience with
                        Cameroon Williamson?</Text>
                    ...
                    <View style={styles.flexView}>
                        <Text style={styles.flexText}>Very Bad</Text>
                        <Text style={styles.flexText}>Excellent</Text>
                    </View>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('Home')}>
                        <Text style={{ fontSize: responsiveFontSize(1.7), color: '#808080', fontFamily: 'PlusJakartaSans-Regular', textAlign: 'center', }}>Skip</Text>
                    </TouchableOpacity>
                </View>
